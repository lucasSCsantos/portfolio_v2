    ...
    <WavesContainer xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 240">
      <motion.g style={{ x: backWaveX }}>
        <motion.path
          ...
          style={{ translateY: '-6rem' }}
          animate={{ x: [-100, 0] }}
          transition={waveTransition(8)}
        />
      </motion.g>
      <motion.g style={{ x: midWaveX }}>
        <motion.path
          fill="#398CBF"
          fillOpacity="1"
          ...
          animate={{ x: [-200, 0] }}
          transition={waveTransition(12, 1.2)}
        />
      </motion.g>
      <motion.g style={{ x: frontWaveX }}>
        <motion.path
          fill="#79BED9"
          fillOpacity="1"
          ...
          animate={{ x: [-300, 0] }}
          transition={waveTransition(18, 0.7)}
        />
      </motion.g>
    </WavesContainer>
  );
